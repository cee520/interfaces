require './application'
Interfaces::Application.initialize!

# Development middlewares
if Interfaces::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => Interfaces::Application.root(:public)
end
...
#
run Interfaces::Application.routes
